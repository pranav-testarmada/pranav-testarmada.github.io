...
layout: training
permalink: documentation/Mocking/Native Android/JAVASCRIPT/Training Guide/Mocking 101/Introduction to Mocking UI
level1: Mocking
...
<p class="training-doc-link__text">
<a class="training-doc-link__text-current" href="./Introduction to Mocking UI">Introduction to Mocking UI</a></p>
</div>
<div class="training-doc-link">
<div class ="training-doc-link-left">
...
<a href="./Adding Routes for Mocking"><img src="/images/training/btn-left.png" srcset="/images/training/btn-left%402x.png 2x, /images/training/btn-left%403x.png 3x" /></a>
</div>
<div class="training-content markdown">
<h3>1. Starting Mocking UI</h3>
<blockquote>
<p>To start Mocking UI, after starting mock server navigate to http://localhost:8000/shifu on your favorite browser.</p>
</blockquote>
<h3>2. Navigating through Mocking UI</h3>
<p>Try to navigate through Mocking UI to get better undertstanding of its functions.</p>
</div>
<div class="training-doc-nav-btn">
<a href="./Introduction to Variants"><img src="/images/training/btn-right.png" srcset="/images/training/btn-right%402x.png 2x, /images/training/btn-right%403x.png 3x" /></a>
</div>
